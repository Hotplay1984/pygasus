...
def update_sql_and_send_email():
	...
	print('Updating CFETS NCD basic infomation')
	...
	df.to_sql('basic_info_ncd',
			 engine,
			 schema='bond',
			 if_exists='replace',
			 index=False)
	local_path = 'C:\\Users\\client\\Desktop\\python_work\\work\\market_data\\'
	file_name = local_path + 'daily_update_cfets_ncdinfo.xls'
	...
	send_mail_via_com('hello Will', 
		...
		select_file = 'daily_update_cfets_ncdinfo.xls')
